...
if __name__ == "__main__":
    ...
    plt.subplot(1, 2, 1)
    plt.ylim([0.0, .5])
    utils.plot_loss(train_loss, "Training Loss (LR = 0.1)")
    utils.plot_loss(val_loss, "Validation Loss (LR = 0.1)")
    utils.plot_loss(train_loss2, "Training Loss with momentum (LR = 0.008)", "b--")
    utils.plot_loss(val_loss2, "Validation Loss with momentum (LR = 0.008)", "y--")
    ...
    # Plot accuracy
    plt.ylim([0.8, 1.0])
    utils.plot_loss(train_accuracy, "Training Accuracy (LR = 0.1)")
    utils.plot_loss(val_accuracy, "Validation Accuracy (LR = 0.1)")
    utils.plot_loss(train_accuracy2, "Training Accuracy with momentum (LR = 0.008)", "b--")
    utils.plot_loss(val_accuracy2, "Validation Accuracy with momentum (LR = 0.008)", "y--")
    plt.legend()
    plt.xlabel("Number of gradient steps")
    plt.ylabel("Accuracy")
    plt.savefig("softmax_train_graph_momentum.png")
    plt.show()
